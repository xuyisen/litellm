...
def run_separate_health_app():
    """Run the health app on a separate port if SEPARATE_HEALTH_APP env var is set to '1'."""
    if os.environ.get("SEPARATE_HEALTH_APP") == "1":
        ...
        thread = threading.Thread(
            target=uvicorn.run,
            kwargs={
                "app": "litellm.proxy.health_endpoints.health_app_factory:build_health_app",
                "host": "0.0.0.0",
                "port": 4001,
                "factory": True,
            },
