...
def get_supports_response_schema(
    ...
    # Normalize model name: strip 'gemini/' prefix for Vertex AI models
    if _custom_llm_provider in ("vertex_ai", litellm.LlmProviders.VERTEX_AI) and model.startswith("gemini/"):
